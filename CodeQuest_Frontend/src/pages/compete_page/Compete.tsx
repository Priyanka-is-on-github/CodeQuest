        ...
        <div className="container mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Compete in real-world coding challenges and get noticed by top
              companies
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              ...
              <a
                href="#upcomming"
                className="px-6 py-3 font-medium text-gray-700 transition duration-300 border-2 border-gray-300 rounded-full hover:border-blue-500 hover:text-blue-600"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {loading ? (
              ...
              activeInternships.map((internship, index) => (
                <div
                  key={index}
                  className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 border border-gray-100 transform hover:-translate-y-2 transition-transform"
                >
              ...
              <div className="col-span-4 text-center py-12">
                ...
                <p className="text-gray-500">Currently no active internships</p>
              </div>
            )}
          </div>
        </div>
